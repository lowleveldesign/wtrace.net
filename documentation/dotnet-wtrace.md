...
- [Dotnet-wtrace output](#dotnet-wtrace-output)
...
You may install dotnet-wtrace as a global .NET tool:

```
dotnet tool install -g dotnet-wtrace
```

Or download the executable (it's a single file application) from the [release page](https://github.com/lowleveldesign/dotnet-wtrace/releases).
